...
public partial class BuscarConsultas : System.Web.UI.Page
{
    ...
    public void CleanSearch()
    {
        ...
        lblConsultaExpediente.Text = string.Empty;
    }
    public void Clean()
    {
    ...
    protected void btnBuscar_Click(object sender, EventArgs e)
    {
        ...
        else if (chkConsultasExpediente.Checked == true)
            lblConsultaExpediente.Text = "1";
    ...
    {
        int consultaId = int.Parse(GridViewConsultas.SelectedRow.Cells[2].Text);

        Session["Consulta"] = Controller.consultaPorId(consultaId);
