<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BuscarAbogados.aspx.cs" Inherits="BuscarAbogados" %>
    ...
    <div align="center">
        <asp:GridView ID="GridViewAbogados" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Id" HeaderText="Legajo" SortExpression="Id" ReadOnly="true" />
