<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdministrarTiposDocumento.aspx.cs" Inherits="AgregarTiposDocumento" %>
    ...
    <tr>
        ...
        <td align="left">
            <asp:GridView ID="GridViewTipoDocumento" runat="server" 
                ...
                onrowdatabound="GridViewTipoDocumento_RowDataBound">
