<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="BuscarClientes, App_Web_3achn1v4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Panel ID="PanelOpciones" runat="server" Visible="false">
        ...
        <asp:LinkButton ID="lnkNuevoTurno" runat="server" onclick="lnkNuevoTurno_Click" > Generar Nuevo Turno </asp:LinkButton>&nbsp; | &nbsp;
        <asp:LinkButton ID="LinkButton1" runat="server" onclick="lnkNuevaConsulta_Click" > Generar Nueva Consulta </asp:LinkButton>&nbsp; | &nbsp;
    ...
    <div align="center" style="overflow: auto">
        <asp:GridView ID="GridViewClientes" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Id" HeaderText="Nro Cliente" SortExpression="Id" ReadOnly="true"/>
