<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="BuscarConsultas, App_Web_3achn1v4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="22px" 
        ...
        Visible="False" 
        Width="100%">
        <asp:Label ID="lblConsultaExpediente" runat="server" Visible="False"></asp:Label>&nbsp;
    ...
    <table align="center" style="width: 445px" border="1">
        ...
        <tr>
            <td colspan="2"> 
                <asp:CheckBox ID="chkConsultasExpediente" runat="server" 
                    Text="Incluir Consultas Ya Derivadas a Expediente" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <div align="center" style="overflow: auto">
        <asp:GridView ID="GridViewConsultas" runat="server" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Id" HeaderText="Nro de Consulta" SortExpression="Id" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceConsultas" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="lblConsultaExpediente" Name="pEstado" PropertyName="Text" Type="String" />
